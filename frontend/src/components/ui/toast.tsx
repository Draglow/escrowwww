...
const toastVariants = cva(
  [
    ...
    "rounded-xl border p-5 pr-8",
    // 3D elevation
    "shadow-[0_8px_24px_rgba(0,0,0,0.12),0_2px_6px_rgba(0,0,0,0.08),inset_0_1px_0_rgba(255,255,255,0.6)]",
    "dark:shadow-[0_8px_24px_rgba(0,0,0,0.4),0_2px_6px_rgba(0,0,0,0.3),inset_0_1px_0_rgba(255,255,255,0.07)]",
    "transition-all",
    ...
    variants: {
      variant: {
        ...
        destructive: [
          ...
          "shadow-[0_8px_24px_hsl(var(--destructive)/0.3),inset_0_1px_0_rgba(255,255,255,0.15)]",
        ].join(" "),
      },
    },
    defaultVariants: {
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ref={ref}
    className={cn(
      "inline-flex h-8 shrink-0 items-center justify-center rounded-lg border bg-transparent px-3 text-sm font-medium",
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ...
    className={cn(
      ...
      "text-foreground/40 opacity-0 transition-all",
      "hover:text-foreground hover:bg-muted/50 hover:opacity-100",
